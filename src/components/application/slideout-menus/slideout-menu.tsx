...
interface SlideoutModalOverlayProps extends AriaModalOverlayProps, RefAttributes<HTMLDivElement> {}

export const SlideoutModalOverlay = (props: SlideoutModalOverlayProps) => {
  return (
    <AriaModalOverlay
      {...props}
      className={(state) =>
...
SlideoutModalOverlay.displayName = 'SlideoutModalOverlay'

interface SlideoutModalProps extends AriaModalOverlayProps, RefAttributes<HTMLDivElement> {}

export const SlideoutModal = (props: SlideoutModalProps) => (
  <AriaModal
    {...props}
    className={(state) =>
      cx(
...
interface SlideoutDialogProps extends AriaDialogProps, RefAttributes<HTMLElement> {}

export const SlideoutDialog = (props: SlideoutDialogProps) => (
  <AriaDialog
    role="dialog"
...
SlideoutDialog.displayName = 'SlideoutDialog'
...
const Menu = ({ children, dialogClassName, ...props }: SlideoutMenuProps) => {
  return (
    <SlideoutModalOverlay {...props}>
      ...
      >
        {(state) => (
          <SlideoutDialog className={dialogClassName}>
            {({ close }) => {
...
const Content = ({ role = 'main', ...props }: ComponentPropsWithRef<'div'>) => {
  return (
    <div
      role={role}
      {...props}
      className={cx('flex size-full flex-col gap-6 overflow-y-auto overscroll-auto px-4 md:px-6', props.className)}
    />
  )
}
...
const Footer = (props: ComponentPropsWithRef<'footer'>) => {
  return (
    <footer
      {...props}
      className={cx('w-full p-4 shadow-[inset_0px_1px_0px_0px] shadow-border-secondary md:px-6', props.className)}
    />
  )
}
