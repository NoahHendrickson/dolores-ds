...
const getTabStyles = ({ isFocusVisible, isSelected, isHovered }: AriaTabRenderProps) => ({
    ...
    "button-minimal": cx(
        "rounded-lg outline-focus-ring transition-shadow duration-100 ease-linear *:data-icon:text-fg-quaternary",
        isFocusVisible && "outline-2 -outline-offset-2",
        // Hover (and selected): subtle background + light drop shadow.
        ...
        // Selected only: full secondary-button styling (chunky shadow + content translate).
        isSelected &&
            "shadow-[0_1px_2px_rgba(0,0,0,0.05),inset_0_0_0_1px_rgba(0,0,0,0.24),inset_0_-4px_0_rgba(0,0,0,0.12)] *:-translate-y-[2px]",
    ),
    underline: cx(
